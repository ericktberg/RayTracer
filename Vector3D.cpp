...
Vector3D::Vector3D(double a, double b, double c) : x_(a), y_(b), z_(c) { normalize(); };

// A vector is the result of a point 2 from point 1
Vector3D::Vector3D(Point3D p2, Point3D p1) : x_(p2.x() - p1.x()), y_(p2.y() - p1.y()), z_(p2.z() - p1.z()) { normalize(); };
